...
from ...models.test_imports_retrieve_prefetch_item import TestImportsRetrievePrefetchItem
...
def _get_kwargs(
    id: int,
    *,
    prefetch: Union[Unset, None, List[TestImportsRetrievePrefetchItem]] = UNSET,
) -> Dict[str, Any]:
    pass
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        prefetch (Union[Unset, None, List[TestImportsRetrievePrefetchItem]]):
