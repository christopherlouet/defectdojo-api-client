...
def _get_kwargs(
    *,
    ...
    prefetch: Union[Unset, None, List[ProductTypeMembersListPrefetchItem]] = UNSET,
    product_type_id: Union[Unset, None, int] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefetch (Union[Unset, None, List[ProductTypeMembersListPrefetchItem]]):
        product_type_id (Union[Unset, None, int]):
