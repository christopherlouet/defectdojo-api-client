...
from ...models.findings_accept_risks_create_created import FindingsAcceptRisksCreateCreated
from ...models.findings_accept_risks_create_date import FindingsAcceptRisksCreateDate
from ...models.findings_accept_risks_create_jira_creation import FindingsAcceptRisksCreateJiraCreation
from ...models.findings_accept_risks_create_jira_last_update import FindingsAcceptRisksCreateJiraLastUpdate
from ...models.findings_accept_risks_create_last_reviewed import FindingsAcceptRisksCreateLastReviewed
from ...models.findings_accept_risks_create_mitigated import FindingsAcceptRisksCreateMitigated
...
def _get_kwargs(
    *,
    ...
    created: Union[Unset, None, FindingsAcceptRisksCreateCreated] = UNSET,
    cvssv3: Union[Unset, None, str] = UNSET,
    cvssv3_score: Union[Unset, None, float] = UNSET,
    cwe: Union[Unset, None, List[int]] = UNSET,
    date: Union[Unset, None, FindingsAcceptRisksCreateDate] = UNSET,
    ...
    jira_change: Union[Unset, None, FindingsAcceptRisksCreateJiraLastUpdate] = UNSET,
    jira_creation: Union[Unset, None, FindingsAcceptRisksCreateJiraCreation] = UNSET,
    last_reviewed: Union[Unset, None, FindingsAcceptRisksCreateLastReviewed] = UNSET,
    last_reviewed_by: Union[Unset, None, List[int]] = UNSET,
    last_status_update: Union[Unset, None, datetime.datetime] = UNSET,
    limit: Union[Unset, None, int] = UNSET,
    mitigated: Union[Unset, None, FindingsAcceptRisksCreateMitigated] = UNSET,
    ...
    o: Union[Unset, None, List[FindingsAcceptRisksCreateOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        created (Union[Unset, None, FindingsAcceptRisksCreateCreated]):
        cvssv3 (Union[Unset, None, str]):
        cvssv3_score (Union[Unset, None, float]):
        cwe (Union[Unset, None, List[int]]):
        date (Union[Unset, None, FindingsAcceptRisksCreateDate]):
        ...
        jira_change (Union[Unset, None, FindingsAcceptRisksCreateJiraLastUpdate]):
        jira_creation (Union[Unset, None, FindingsAcceptRisksCreateJiraCreation]):
        last_reviewed (Union[Unset, None, FindingsAcceptRisksCreateLastReviewed]):
        last_reviewed_by (Union[Unset, None, List[int]]):
        last_status_update (Union[Unset, None, datetime.datetime]):
        limit (Union[Unset, None, int]):
        mitigated (Union[Unset, None, FindingsAcceptRisksCreateMitigated]):
        ...
        o (Union[Unset, None, List[FindingsAcceptRisksCreateOItem]]):
