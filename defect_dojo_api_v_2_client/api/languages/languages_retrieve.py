...
from ...models.languages_retrieve_prefetch_item import LanguagesRetrievePrefetchItem
...
def _get_kwargs(
    id: int,
    *,
    prefetch: Union[Unset, None, List[LanguagesRetrievePrefetchItem]] = UNSET,
) -> Dict[str, Any]:
    pass
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        prefetch (Union[Unset, None, List[LanguagesRetrievePrefetchItem]]):
