...
from ...models.product_members_retrieve_prefetch_item import ProductMembersRetrievePrefetchItem
...
def _get_kwargs(
    id: int,
    *,
    prefetch: Union[Unset, None, List[ProductMembersRetrievePrefetchItem]] = UNSET,
) -> Dict[str, Any]:
    pass
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        prefetch (Union[Unset, None, List[ProductMembersRetrievePrefetchItem]]):
