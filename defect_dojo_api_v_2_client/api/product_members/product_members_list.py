...
def _get_kwargs(
    *,
    ...
    prefetch: Union[Unset, None, List[ProductMembersListPrefetchItem]] = UNSET,
    product_id: Union[Unset, None, int] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefetch (Union[Unset, None, List[ProductMembersListPrefetchItem]]):
        product_id (Union[Unset, None, int]):
