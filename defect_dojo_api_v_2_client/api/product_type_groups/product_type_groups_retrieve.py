...
from ...models.product_type_groups_retrieve_prefetch_item import ProductTypeGroupsRetrievePrefetchItem
...
def _get_kwargs(
    id: int,
    *,
    prefetch: Union[Unset, None, List[ProductTypeGroupsRetrievePrefetchItem]] = UNSET,
) -> Dict[str, Any]:
    pass
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        prefetch (Union[Unset, None, List[ProductTypeGroupsRetrievePrefetchItem]]):
