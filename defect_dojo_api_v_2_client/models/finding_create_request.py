...
class FindingCreateRequest:
    ...
    def to_multipart(self) -> Dict[str, Any]:
        ...
        _temp_found_by = self.found_by
        found_by = (None, json.dumps(_temp_found_by).encode(), "application/json")
        ...
        thread_id = (
            self.thread_id if isinstance(self.thread_id, Unset) else (None, str(self.thread_id).encode(), "text/plain")
        )
