...
T = TypeVar("T", bound="PaginatedGlobalRoleList")


@_attrs_define
class PaginatedGlobalRoleList:
    """
    Attributes:
        ...
        results (Union[Unset, List['GlobalRole']]):
    """

    count: Union[Unset, int] = UNSET
    next_: Union[Unset, None, str] = UNSET
    previous: Union[Unset, None, str] = UNSET
    results: Union[Unset, List["GlobalRole"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = GlobalRole.from_dict(results_item_data)

            results.append(results_item)

        paginated_global_role_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_global_role_list.additional_properties = d
        return paginated_global_role_list
