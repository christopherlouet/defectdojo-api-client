...
T = TypeVar("T", bound="PaginatedJIRAIssueList")


@_attrs_define
class PaginatedJIRAIssueList:
    """
    Attributes:
        ...
        results (Union[Unset, List['JIRAIssue']]):
    """

    count: Union[Unset, int] = UNSET
    next_: Union[Unset, None, str] = UNSET
    previous: Union[Unset, None, str] = UNSET
    results: Union[Unset, List["JIRAIssue"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = JIRAIssue.from_dict(results_item_data)

            results.append(results_item)

        paginated_jira_issue_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_jira_issue_list.additional_properties = d
        return paginated_jira_issue_list
